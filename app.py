...
def fetch_data(ticker_list):
    ...
    # Rimozione automatica delle colonne che contengono SOLO valori vuoti (None / NaN)
    df_cleaned = df_raw.dropna(how='all', axis=1)
...
# Mappa delle formattazioni numeriche
format_dict = {
    "Prezzo ($)": "${:,.2f}",
    "Basic EPS TTM ($)": "${:,.2f}",
    "Diluted EPS TTM ($)": "${:,.2f}",
